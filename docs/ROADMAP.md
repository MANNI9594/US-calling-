...
**Not yet verified live** — this page has not yet been tested against the real Railway deployment. Next action: user opens `/evidence-review.html`, reviews the 35 `NEEDS_REVIEW` images from the real import, and reports back what works and what doesn't.
